                                        ...
                                        ; --- START PROC LE000 ---
E000: F3                         LE000: DI
E001: 31 80 F9                          LD      SP,0F980h
E004: 21 E1 E5                          LD      HL,0E5E1h
E007: 22 00 F9                          LD      (0F900h),HL
E00A: 3E C9                             LD      A,0C9h
E00C: 32 02 F9                          LD      (0F902h),A
E00F: CD 00 F9                          CALL    0F900h
E012: 11 EE FF                          LD      DE,0FFEEh
E015: 19                                ADD     HL,DE
E016: 11 00 E0                          LD      DE,0E000h
E019: 01 00 10                          LD      BC,1000h
E01C: ED B0                             LDIR
E01E: C3 21 E0                          JP      LE021

E021: F3                         LE021: DI
E022: 31 FF FC                          LD      SP,0FCFFh
E025: AF                                XOR     A
E026: D3 12                             OUT     (12h),A
E028: D3 13                             OUT     (13h),A
E02A: D3 10                             OUT     (10h),A
E02C: D3 11                             OUT     (11h),A
E02E: DB 34                             IN      A,(34h) ; '4'
E030: E6 05                             AND     05h
E032: 11 00 20                          LD      DE,2000h
E035: 21 00 10                          LD      HL,1000h
E038: FE 01                             CP      01h
E03A: CA 4E E0                          JP      Z,LE04E
E03D: 11 00 40                          LD      DE,4000h
E040: 21 00 40                          LD      HL,4000h
E043: FE 04                             CP      04h
E045: CA 4E E0                          JP      Z,LE04E
E048: 11 00 20                          LD      DE,2000h
E04B: 21 00 80                          LD      HL,8000h
E04E: 22 22 FE                   LE04E: LD      (0FE22h),HL
E051: ED 53 24 FE                       LD      (0FE24h),DE
E055: 21 2B E2                          LD      HL,0E22Bh
E058: CD 91 EA                          CALL    LEA91
E05B: CD EF E3                          CALL    LE3EF
E05E: CD BB E8                          CALL    LE8BB
E061: 21 63 E2                          LD      HL,0E263h
E064: CD 9C EA                          CALL    LEA9C
E067: DB 34                      LE067: IN      A,(34h) ; '4'
E069: E6 0A                             AND     0Ah
E06B: 0E 00                             LD      C,00h
E06D: CA 80 E0                          JP      Z,LE080
E070: 0E 01                             LD      C,01h
E072: FE 08                             CP      08h
E074: CA 80 E0                          JP      Z,LE080
E077: 0E 02                             LD      C,02h
E079: FE 02                             CP      02h
E07B: CA 80 E0                          JP      Z,LE080
E07E: 0E 03                             LD      C,03h
E080: 1E 01                      LE080: LD      E,01h
E082: CD AB E1                          CALL    LE1AB
E085: 7C                                LD      A,H
E086: B5                                OR      L
E087: CA 67 E0                          JP      Z,LE067
E08A: D5                                PUSH    DE
E08B: DD E1                             POP     IX
...
E13C: C3 EB E0                          JP      LE0EB
                                        ...
                                        ; --- START PROC LE13F ---
E13F: ED 73 7E FD                LE13F: LD      (0FD7Eh),SP
E143: 31 7E FD                          LD      SP,0FD7Eh
E146: E5                                PUSH    HL
E147: D5                                PUSH    DE
E148: C5                                PUSH    BC
E149: F5                                PUSH    AF
E14A: 2A 24 FE                          LD      HL,(0FE24h)
...
EA9A: 18 F5                             JR      LEA91
                                        ...
                                        ; --- START PROC LEA9C ---
EA9C: 7E                         LEA9C: LD      A,(HL)
EA9D: 23                                INC     HL
EA9E: A7                                AND     A
EA9F: C8                                RET     Z
EAA0: E5                                PUSH    HL
EAA1: 4F                                LD      C,A
EAA2: CD 3F E1                          CALL    LE13F
EAA5: E1                                POP     HL
EAA6: 18 F4                             JR      LEA9C
...
references to external address 0FE24h:
        E051 LD (0FE24h),DE
        E14A LD HL,(0FE24h)
...
possible references to external address 0F980h:
        E001 LD SP,0F980h
